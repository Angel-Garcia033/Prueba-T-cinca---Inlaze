...
public class FillRegistrationForm implements Task {
    ...
    public FillRegistrationForm(String fullName, String email, String password, String confirmPassword) {
    ...
    public static FillRegistrationForm withData(String fullName, String email, String password, String confirmPassword) {
        return new FillRegistrationForm(fullName, email, password, confirmPassword);
    }
